...
export const createReport = async (req, res) => {
    try {
        ...
        const result = await createReportService(id, reportDetails.Location,
            reportDetails.Type, reportDetails.Description, reportDetails.NoiseLevel, reportDetails.SourceOfNoise,
            reportDetails.DurationOfNoise, reportDetails.SupportingDocuments);
